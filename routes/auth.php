...
// Rotas para registro, somente se o usuário autenticado for um admin
Route::get('register', function () {
    ...
    return redirect('/dashboard')->with('status', 'Você não tem permissão para acessar esta página.');
})->name('register');
